...
Start commiting your changes by using
    git commit -a
The default commit message will be loaded and when you save your commit, it will be remember next time. If you want to load default message again, type <c-l>
